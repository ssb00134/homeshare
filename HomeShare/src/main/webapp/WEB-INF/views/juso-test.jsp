...
<body>
	<form name="form" id="form" method="post">
		...
		<input type="text" name="confmKey" id="confmKey"
			style="width: 250px; display: none" value="devU01TX0FVVEgyMDIwMDUyMTEwNDk1NTEwOTc4MzE=" />
		keyword :
		...
		<input type="button" onClick="getAddrTest();"
			value="개발테스트_주소가져오기_domainChk" />
		<input type="button" onClick="getAddrLocTest();"
			value="개발테스트_주소가져오기_ipChk" />
