	...
	<div class="container-fluid">
		<div class="row">
			<nav class="col-md-2 d-none d-md-block bg-light sidebar">
				<div class="sidebar-sticky">
					<ul class="nav flex-column">
						...
						<li class="nav-item"  id="reportManageMent"><a class="nav-link" href="#">
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
									viewBox="0 0 24 24" fill="none" stroke="currentColor"
									stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
						...
						<li class="nav-item" id="houseManagement"><a class="nav-link" href="#">
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
									viewBox="0 0 24 24" fill="none" stroke="currentColor"
									stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
			...
			<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
				...
				<h1 class="h2">관리자페이지</h1>
				<div id="contents">페이지가 전환될 영역</div>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$('#reportManageMent').click(function(){
				$("#contents").load("/homeshare/admin/reportmanagement");
			}); //end crmsidebar clikc
